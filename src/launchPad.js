...
const LAUNCH_PAD_VIEW_TYPE = "colins-launch-pad.view";
...
function builtInLaunchPadItems(snapshot) {
  ...
  items.push(
    launchPadItem({
      id: "command:bug-report-builder.create",
      label: "Bug Report Builder",
      type: "command",
      target: "bug-report-builder.create",
      detail: "Create a GitHub-ready issue draft",
      group: "Suite",
      badge: "bug"
    }),
    launchPadItem({
      id: "command:colins-readme-studio.open",
      label: "README Studio",
      type: "command",
      target: "colins-readme-studio.open",
      detail: "Build or polish README.md",
      group: "Suite",
      badge: "docs"
    }),
    launchPadItem({
      id: "command:snippet-forge.createFromSelection",
      label: "Snippet Forge",
      type: "command",
      target: "snippet-forge.createFromSelection",
      detail: "Turn selected code into a snippet",
      group: "Suite",
      badge: "snippet"
    }),
    launchPadItem({
      id: "command:project-command-center.open",
      label: "Project Command Center",
      type: "command",
      target: "project-command-center.open",
      detail: "Open the sidebar dashboard",
      group: "Suite",
      badge: "suite"
    }),
    launchPadItem({
      id: "command:theme-reactor.applyThemeReactorNow",
      label: "Apply Theme Reactor",
      type: "command",
      target: "theme-reactor.applyThemeReactorNow",
  ...
  items.push(
    ...
    launchPadItem({
      id: "command:project-command-center.createMissingBasics",
      label: "Create Missing Basics",
      type: "command",
      target: "project-command-center.createMissingBasics",
...
async function runLaunchPadItem(itemId) {
  ...
  if (item.type === "script") {
    const terminal = vscode.window.createTerminal({
      name: `Launch Pad: ${item.target}`,
      cwd: snapshot.root
    });
    terminal.show();
    terminal.sendText(scriptCommand(snapshot.packageManager, item.target));
    return;
  }
...
function registerLaunchPad(context) {
  context.subscriptions.push(
    vscode.commands.registerCommand("colins-launch-pad.open", openLaunchPad),
